    ...
    tabPanel("Tomato", h1("Tomatoproduktion"),
             ...
             fluidRow(
               ...
               column(7, 
                      ...
                      p(),
                      h3(strong('sonstige Variable')),
                       sidebarPanel(width = 12,
                                    style = "height: 15vh; overflow-y: auto;", #height in %
               ...
               column(5, 
                        ...
                        plotOutput("distPlot1",height = "250px",
                                   width = "95%"),
                        p ("The NPV gives the number of times (“frequency”) that each 
                                           outcome of the distribution was realized when the model was simulated."),
                        # h5("2.Title"),
                        ...
                        plotOutput("distPlot3",height = "250px",
                                   width = "95%"),
                        p("The cash flow is a series of monetary values, either negative 
                                          (e.g. initial investment costs of interventions) or positive 
                                          (e.g. marginal revenue generated by the interventions in a specific year) 
                                          over a time period. On the figure, uncertainty on the value of the cash flow 
                                          is represented by quantiles around the median.")
